...
typedef void OnItemTaped<T>(
    BuildContext context, T data, int index, int currentItemType);

abstract class BaseListItemHolderBuilder<T> {
  late List<T> currentListData;
    ...
    return GestureDetector(
        ...
        onTap: () {
          if (itemTapCallback != null) {
            itemTapCallback(context, listData[index], index,
                getItemType(listData[index], index));
          }
        });
  }
